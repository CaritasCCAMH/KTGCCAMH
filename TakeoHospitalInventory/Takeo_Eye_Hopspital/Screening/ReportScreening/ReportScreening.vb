...
Public Class ReportScreening
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KTGSYS.ReportScreening.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Function() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportScreening
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportScreening = New ReportScreening
        rpt.Site = Me.Site
        Return rpt
    End Function
