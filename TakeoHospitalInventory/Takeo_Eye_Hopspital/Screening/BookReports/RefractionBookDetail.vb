...
Public Class RefractionBookDetail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RefractionBookDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRefractionBookDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RefractionBookDetail = New RefractionBookDetail
        rpt.Site = Me.Site
        Return rpt
    End Function
