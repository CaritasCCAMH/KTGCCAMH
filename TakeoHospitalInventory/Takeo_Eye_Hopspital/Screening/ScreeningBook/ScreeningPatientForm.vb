...
Public Class ScreeningPatientForm
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ScreeningPatientForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedScreeningPatientForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ScreeningPatientForm = New ScreeningPatientForm
        rpt.Site = Me.Site
        Return rpt
    End Function
